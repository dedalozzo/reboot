        ...
        <fieldset>
          ...
          <table id="blacklist" class="std gutter">
            ...
            {% for member in blacklist %}
              <tr>
                <td><a class="avatar" href="//{{ serverName }}/{{ member['value'][0] }}"><img class="img-polaroid" src="{{ member['value'][1] }}&s=24" /></a></td>
                <td width="40%"><a href="//{{ serverName }}/{{ member['value'][0] }}">{{ member['value'][0] }}</a></td>
                <td width="60%">{{ member['value'][3]~' '~member['value'][4] }}</td>
